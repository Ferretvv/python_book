...
# associated with variable a to variable b, the variables share that object. However, if the value assigned to 
# b is an entirely new object, there is no sharing, even if the values are identical.